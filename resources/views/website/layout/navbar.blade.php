<nav class="navbar bg-body-tertiary" style="background-color: white">
    <div class="container-fluid sticky1 justify-content-around p-2">
        ...
        <div class="nav-rightside justify-content-center col-md-10 d-flex gap-3 hidden" id="">
            <div class="col-2 phone-container">
            ...
            <div class="telegram-container gap-2">
                <a href="http://">
                    <i class="fa-brands fa-telegram " style="color:#24a2df;"></i>
                </a>
                <a href="http://">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav justify-content-center gap-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-center justify-content-center" aria-current="page"
                                href="#">{{ __('ACCESSORIES') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-center justify-content-center" aria-current="page"
                                href="#"><i class="fa-solid fa-user-gear px-2"
                                    style="color:#ffffff;"></i>{{ __('SERVICES') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-center justify-content-center" aria-current="page"
                                href="#"><i class="fa-solid fa-circle-exclamation px-2"
                                    style="color: #ffffff;"></i>{{ __('ABOUT US') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active text-center justify-content-center" aria-current="page"
                                href="#"><i class="fa-solid fa-user-pen px-2"
                                    style="color: #ffffff;"></i>{{ __('Contact Us') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
