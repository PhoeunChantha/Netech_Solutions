            ...
            <div class="row mx-auto justify-content-center p-3 align-items-center">
                ...
                <div class="summary-card">
                    <div class="card-content">
                        ...
                        <div class="info-container">
                            <h3 class="value" id="productValue" data-value="{{ $products->count() }}">0</h3>
                ...
                <div class="summary-card">
                    <div class="card-content">
                        ...
                        <div class="info-container">
                            <h3 class="value" id="orderValue" data-value="{{ $totalorder }}">0</h3>
                ...
                <div class="summary-card">
                    <div class="card-content">
                        ...
                        <div class="info-container">
                            <h3 class="value" id="expenseValue" data-value="{{ $totalexpense }}">$0</h3>
                ...
                <div class="summary-card">
                    <div class="card-content">
                        ...
                        <div class="info-container">
                            <h3 class="value" id="incomeValue" data-value="{{ $totalincome }}">$0</h3>
...
@push('js')
    ...
    //                     </tr>`;
        ...
        $(document).ready(function() {
            function animateCounter($element, isCurrency = false) {
                var $this = $element;
                var targetValue = parseFloat($this.data('value'));
                ...
                var timer = setInterval(function() {
                    ...
                    if (isCurrency) {
                        ...
                        formattedValue = Math.round(currentValue).toLocaleString('en-US');
                    }
            ...
            setTimeout(function() {
                animateCounter($('#productValue'));
            }, 200);
            setTimeout(function() {
                animateCounter($('#orderValue'));
            }, 400);
            setTimeout(function() {
                animateCounter($('#expenseValue'), true);
            }, 600);
            setTimeout(function() {
                animateCounter($('#incomeValue'), true);
            }, 800);
        });
    </script>
@endpush
